...
```bash
$ composer require shapecode/imap
```
...
```php
use Shapecode\Imap\Server;

$server = new Server('imap.gmail.com');

// $connection is instance of \Shapecode\Imap\Connection
...
foreach ($mailboxes as $mailbox) {
    // $mailbox is instance of \Shapecode\Imap\Mailbox
...
foreach ($messages as $message) {
    // $message is instance of \Shapecode\Imap\Message
}
```
...
```php
use Shapecode\Imap\SearchExpression;
use Shapecode\Imap\Search\Email\To;
use Shapecode\Imap\Search\Text\Body;
...
Get message headers as a [\Shapecode\Imap\Message\Headers](/src/Ddeboer/Imap/Message/Headers.php) object:
...
foreach ($attachments as $attachment) {
    // $attachment is instance of \Shapecode\Imap\Message\Attachment
}
```
